...
contract Grimoire {
    ...
    IGrimoireStore grimoireStore;

    constructor(IGrimoireStore _grimoireStore) {
        grimoireStore = _grimoireStore;
    }
    ...
    {
        return grimoireStore.getWizardToName(wizardId);
    }
    ...
    {
        //ignore id
        (, t0, t1, t2, t3, t4, t5) = _decode(
            grimoireStore.getWizardTraitsEncoded(wizardId)
        );
    }
        ...
        returns (bool)
    {
        (
            ...
            uint16 t4,
            uint16 t5
        ) = _decode(grimoireStore.getWizardTraitsEncoded(wizardId));
    ...
    {
        return grimoireStore.getTraitsToAffinities(traitId);
    }
    ...
    function getAllTraitsAffinities(uint16[5] memory traitId)
        ...
        returns (uint16[] memory)
    {
        uint16[] memory affinityT1 = grimoireStore.getTraitsToAffinities(
            traitId[0]
        );
        uint16[] memory affinityT2 = grimoireStore.getTraitsToAffinities(
            traitId[1]
        );
        uint16[] memory affinityT3 = grimoireStore.getTraitsToAffinities(
            traitId[2]
        );
        uint16[] memory affinityT4 = grimoireStore.getTraitsToAffinities(
            traitId[3]
        );
        uint16[] memory affinityT5 = grimoireStore.getTraitsToAffinities(
            traitId[4]
        );
    ...
    function getTraitIdentityAffinities(uint16 traitId)
        ...
        returns (uint16[] memory)
    {
        return grimoireStore.getTraitsToIdentity(traitId);
    }
    ...
    function getTraitPositiveAffinities(uint16 traitId)
        ...
        returns (uint16[] memory)
    {
        return grimoireStore.getTraitsToPositive(traitId);
    }
        ...
        returns (uint16[] memory)
    {
        ...
        uint16[] memory affinityT1 = grimoireStore.getTraitsToIdentity(t1);
        uint16[] memory affinityT2 = grimoireStore.getTraitsToIdentity(t2);
        uint16[] memory affinityT3 = grimoireStore.getTraitsToIdentity(t3);
        uint16[] memory affinityT4 = grimoireStore.getTraitsToIdentity(t4);
        uint16[] memory affinityT5 = grimoireStore.getTraitsToIdentity(t5);
        ...
        returns (uint16[] memory)
    {
        ...
        uint16[] memory affinityT1 = grimoireStore.getTraitsToPositive(t1);
        uint16[] memory affinityT2 = grimoireStore.getTraitsToPositive(t2);
        uint16[] memory affinityT3 = grimoireStore.getTraitsToPositive(t3);
        uint16[] memory affinityT4 = grimoireStore.getTraitsToPositive(t4);
        uint16[] memory affinityT5 = grimoireStore.getTraitsToPositive(t5);
